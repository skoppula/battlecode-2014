        ...
        public static void run(RobotController rcin){
                ...
                while(true){
                        try{
                                ...
                                //Here would probably be a good idea to put a contition saying - if PASTR robot has not produced enough milk in the last 100 turns, suicide it
                                rc.yield();
                        }catch (Exception e){
                                e.printStackTrace();
                        }
